...
const DataContext1 = ({ children }) => {
    ...
    const getProduct = () => {
        setLoading(true)
        const api = updatedUrl(`${Ayurveda_API}?_page=${page}&_limit=20`, sort, order, subCategory, sortCategory, manufacturer, sliderVal)
        console.log(api)
        axios.get(api)
            .then(res => {
                setLoading(false)
